...
export const findMovieById = (mid: string) => moviesModel.findById(mid);

export const createMovie = (movie: any) => moviesModel.create(movie);

export const deleteMovie = (mid: string) => moviesModel.deleteOne({ _id: mid });

export const updateMovie = (mid: string, newMovie: any) =>
  moviesModel.updateOne({ _id: mid }, { $set: newMovie });
